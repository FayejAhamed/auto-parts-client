...
const Purchase = () => {
    ...
    const { data, isLoading } = useQuery('services', () => fetch(`https://protected-sierra-14862.herokuapp.com/purchase/${id}`, {
        method: 'GET',
        headers: {
...
// console.log(data);
    ...
    // useEffect(() => {
    //     fetch(`https://protected-sierra-14862.herokuapp.com/purchase/${_id}`, {
    //         method: 'GET',
    //         headers: {
    //             'authorization': `Bearer ${localStorage.getItem('accessToken')}`
    //         }
    ...
    const onSubmit = event => {
        ...
        if (inputQunentity < minimumQuantity) {
            ...
            // /order
            fetch('https://protected-sierra-14862.herokuapp.com/order', {
                method: 'POST',
                headers: {
